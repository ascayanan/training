...
$ggdata['name'] = $this->input->post('name');

$ggdata['email'] = $this->input->post('email');

$ggdata['address'] = $this->input->post('address');

$ggdata['mobile'] = $this->input->post('mobile');

$res = $this->users_model->insert_users_to_db($ggdata);
